...
import subprocess
import os
from HumanSDG_300_PeopleSansPeopleParameter import HumanSDGParameter
import collections
import time
...
class Looper:
    ...
    def loop(self):
        ...
        while self.__gen_num_counter < self.__gen_num:
            ...
            ## get PeopleSansPeopleSDG_400_DataGenerator.py path
            module_path = os.path.dirname(os.path.abspath(__file__))
            data_generator_path = os.path.join(module_path,"PeopleSansPeopleSDG_400_DataGenerator.py")
