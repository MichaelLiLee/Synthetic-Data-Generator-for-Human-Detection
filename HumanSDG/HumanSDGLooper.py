...
class Looper:
    """ 
    A class for repeatedly run the file HumanSDG_400_DataGenerator.py in Blender, this class also provide the Estimated time consumption 
    ...
    __logger (dict of str: depend on parameter type): Log configuration form HumanSDGParameter class.
    ...
    def loop(self):
        ...
        parameter = PeopleSansPeopleParameter()
        ...
        while self.__gen_num_counter < self.__gen_num:
            ...
            # Get HumanSDG_400_DataGenerator.py path
            module_path = os.path.dirname(os.path.abspath(__file__))
            data_generator_path = os.path.join(module_path,"HumanSDG_400_DataGenerator.py")
